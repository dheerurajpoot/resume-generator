          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateData("personalInfo", { ...data.personalInfo, fullName: e.target.value })}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateData("personalInfo", { ...data.personalInfo, email: e.target.value })}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateData("personalInfo", { ...data.personalInfo, phone: e.target.value })}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateData("personalInfo", { ...data.personalInfo, website: e.target.value })}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateData("personalInfo", { ...data.personalInfo, location: e.target.value })}
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateData("skills", { ...data.skills, frontend: e.target.value.split(", ").filter((s) => s.trim()) })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateData("skills", { ...data.skills, backend: e.target.value.split(", ").filter((s) => s.trim()) })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateData("skills", { ...data.skills, database: e.target.value.split(", ").filter((s) => s.trim()) })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateData("skills", { ...data.skills, tools: e.target.value.split(", ").filter((s) => s.trim()) })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateData("skills", { ...data.skills, other: e.target.value.split(", ").filter((s) => s.trim()) })
              }
