      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Build a professional resume in minutes with our intuitive generator. Choose from beautiful templates and
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-6 mb-8">
            ...
            <div className="w-full max-w-4xl">
              <h3 className="text-lg font-semibold text-center mb-4">Choose Your Template</h3>
              <TemplateShowcase selectedTemplate={selectedTemplate} onTemplateSelect={setSelectedTemplate} />
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className={`${currentView === "form" ? "block" : "hidden lg:block"}`}>
              <ResumeForm data={resumeData} onChange={handleDataChange} />
            </div>
            <div className={`${currentView === "preview" ? "block" : "hidden lg:block"}`}>
